import { kiet, bvm, amity, icpc, uiux, cp, kts } from "../assets";
...
export const resumeLink =
	"https://acrobat.adobe.com/id/urn:aaid:sc:AP:5554cb66-21cb-456f-af10-c9f28c38992e";
...
export const projects = [
	{
		id: "project-1",
		title: "Thinkly",
		github: "https://github.com/vidushish/Thinkly", // replace with actual repo link
		link: "https://thinkly-chat.vercel.app/",
		content:
			"A full-stack conversational chat platform featuring JWT authentication, chat history management, and Gemini API integration for real-time responses.",
		stack: [
			{ id: "th-1", icon: SiReact, name: "React.js" },
			{ id: "th-2", icon: SiExpress, name: "Express.js" },
			{ id: "th-3", icon: SiMongodb, name: "MongoDB Atlas" },
			{ id: "th-4", icon: SiJavascript, name: "JWT" },
			{ id: "th-5", icon: SiNodedotjs, name: "Gemini API" },
		],
	},
	{
		id: "project-2",
